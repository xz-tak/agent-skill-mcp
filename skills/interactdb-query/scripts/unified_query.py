...
try:
    from biogrid_api import BioGRIDClient, DEFAULT_BIOGRID_API_KEY
    BIOGRID_AVAILABLE = True
except ImportError:
    BIOGRID_AVAILABLE = False
    DEFAULT_BIOGRID_API_KEY = None
...
def query_single_gene_all_databases(
    ...
    **kwargs : dict
    ...
    # Query BioGRID (uses default API key if none provided)
    ...
    if not BIOGRID_AVAILABLE:
        ...
        try:
            # BioGRIDClient uses default API key if none provided
