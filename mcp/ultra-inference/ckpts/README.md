...
The MCP server will:
1. Check if the checkpoint (`ultra_primekg_50g_ft_epoch_1.pth`) exists
...
The checkpoint (`ultra_primekg_50g_ft_epoch_1.pth`) is:
- **Base model**: ULTRA 50g (pre-trained on 50 knowledge graphs)
